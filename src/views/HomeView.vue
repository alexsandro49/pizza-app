...
<template>
  ...
  class="flex flex-col w-screen h-screen p-8 items-center overflow-hidden bg-isabelline dark:bg-charcoal
  xl:grid xl:grid-cols-5 xl:grid-rows-4">
    <div class="orange-bg-tomato rounded-full mt-[-50vh] mb-5 w-[570px] h-[555px] md:self-start md:w-[101vw] md:rounded-l md:mt-[-42vh] ml-[-4vw] md:mb-8
  ...
  xl:place-self-start">
    ...
    <h1 class="text-tomato text-2xl font-bold md:self-start
