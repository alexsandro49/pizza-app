...
<template>
  <main :class="{ dark: darkTheme }"
    ...
    <LoginForm v-if="login" :input-type="inputType" :input-icon="inputIcon" :theme="darkTheme"
      @change-form-type="changeFormType" @change-current-icon="changeCurrentIcon" />
    <SignUpForm v-else :input-type="inputType" :input-icon="inputIcon" :theme="darkTheme"
      @change-form-type="changeFormType" @change-current-icon="changeCurrentIcon" />
    ...
    <div
      ...
      @click="changeTheme">
      <font-awesome-icon class="text-tomato-red text-xl group-hover:text-small-gray" :icon="themeIcon" />
    </div>
  </main>
</template>
